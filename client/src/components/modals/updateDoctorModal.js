...
import { getAllDoctorsAsync } from "../../slices/doctor_slice";
...
const UpdateDoctorModal = ({ show, handleClose, doctorData, showToast,handleUpdateDoctorData,setShowToast,toastMessage }) => {
