...
const AddPrescriptionModal = ({ show, handleClose }) => {
  ...
  const handleAddPrescription = (formValue) => {
    ...
    const { diseaseName, medicineName, description, dosage , compliant, investigationResult,treatment, doctorId,patientId} = formValue;
    dispatch(
      addPrescriptionData({
    id,
    compliant,
        ...
        >
          {({
            ...
            <Form onSubmit={handleSubmit} className="text-primary">
              ...
              <Form.Label className="mt-3"> investigationResult</Form.Label>
              <InputGroup hasValidation>
                <Form.Control
                  type="text"
                  name="investigationResult"
                  placeholder="investigationResult"
                  value={values.investigationResult}
                  onChange={handleChange}
                  isValid={touched.investigationResult && !errors.investigationResult}
                  isInvalid={!!errors.investigationResult}
                  required
                />

                <Form.Control.Feedback type="invalid" tooltip>
                  {errors.investigationResult}
                </Form.Control.Feedback>
              </InputGroup>
              ...
              <Form.Label className="mt-3">patientId</Form.Label>
              <InputGroup hasValidation>
                <Form.Control
                  type="text"
                  name="patientId"
